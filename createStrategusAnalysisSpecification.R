...
library(dplyr)
rootFolder <- "E:/git/anthonysena/FluoroquinaloneAorticAneurysm"
...
studyStartDate <- '20100101' #limit to data post-2010 # YYYYMMDD, e.g. "2001-02-01" for January 1st, 2001
studyEndDate <- '20191231'   #limit to data pre-COVID # YYYYMMDD
